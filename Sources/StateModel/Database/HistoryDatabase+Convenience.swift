...
extension HistoryDatabaseProtocol {
     ...
     */
    public func all<Instance: ModelProtocol>(at date: Date?, where predicate: (Instance) -> Bool) -> [Instance] where Instance.Storage == Self {
     ...
     */
    @inline(__always)
    public func all<Instance>(at date: Date?, of type: Instance.Type = Instance.self) -> [Instance] where Instance: ModelProtocol, Instance.Storage == Self {
    ...
    /**
     ...
     - Returns: The instances in the database that match the predicate
     */
    func all<Instance>(_ model: Instance.Type, at date: Date?, where predicate: (Instance) -> Bool) -> [Instance] where Instance: ModelProtocol, Instance.Storage == Self {
        all(at: date, where: predicate)
    }

    public func create<Instance>(id: InstanceKey, at date: Date?, of type: Instance.Type = Instance.self) -> Instance where Instance: ModelProtocol, Instance.Storage == Self {
     ...
     */
    public func get<Instance>(id: InstanceKey, at date: Date?, of type: Instance.Type = Instance.self) -> Instance? where Instance: ModelProtocol, Instance.Storage == Self {
    ...
    public func active<Instance>(id: InstanceKey, at date: Date?, of type: Instance.Type = Instance.self) -> Instance? where Instance: ModelProtocol, Instance.Storage == Self {
     ...
     */
    public func getOrCreate<Instance>(id: InstanceKey, at date: Date?, of type: Instance.Type = Instance.self) -> Instance where Instance: ModelProtocol, Instance.Storage == Self {
     ...
     */
    public func delete<Instance>(_ instance: Instance, at date: Date?) where Instance: ModelProtocol, Instance.Storage == Self {
