...
public typealias ObservableModel<ModelKey: ModelKeyType, InstanceKey: InstanceKeyType, PropertyKey: PropertyKeyType> = ObservableBaseModel<ModelKey, InstanceKey, PropertyKey> & ModelProtocol

/**
 The base class for model classes that are observable.
 */
@available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
open class ObservableBaseModel<ModelKey: ModelKeyType, InstanceKey: InstanceKeyType, PropertyKey: PropertyKeyType>: BaseModel<ModelKey, InstanceKey, PropertyKey>, ObservableObject {
